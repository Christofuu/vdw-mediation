...
<div>
  ...
  <ul>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to VanDeWeghe Mediation, accessible from
        <a
          href="https://vdwmediation.com"
          rel="external nofollow noopener"
          target="_blank">https://vdwmediation.com</a
        >
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>
      By email: <a href="mailto:bill@vdwmediation.com">bill@vdwmediation.com</a
      >, <a href="mailto:traci@vdwmediation.com">traci@vdwmediation.com</a>
    </li>
  </ul>
</div>
